...
export class VmWasm {
    ...
    static __wrap(ptr) {
        const obj = Object.create(VmWasm.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_vmwasm_free(ptr);
    }
    /**
    */
    constructor() {
        var ret = wasm.vmwasm_new();
        return VmWasm.__wrap(ret);
    }
    /**
    ...
    */
    load_game(data) {
        try {
            wasm.vmwasm_load_game(this.ptr, addBorrowedObject(data));
        } finally {
    ...
    */
    draw(scale) {
        wasm.vmwasm_draw(this.ptr, scale);
    }
    /**
    */
    tick() {
        wasm.vmwasm_tick(this.ptr);
    }
    /**
    */
    tick_timers() {
        wasm.vmwasm_tick_timers(this.ptr);
    }
    /**
    */
    reset() {
        wasm.vmwasm_reset(this.ptr);
    }
    /**
    ...
    */
    keypress(event, pressed) {
        try {
            wasm.vmwasm_keypress(this.ptr, addBorrowedObject(event), pressed);
        } finally {
            heap[stack_pointer++] = undefined;
        }
    }
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('chimp_wasm_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
